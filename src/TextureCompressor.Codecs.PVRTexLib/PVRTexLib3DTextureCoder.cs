...
public sealed unsafe class PVRTexLib3DTextureCoder : IPitchTextureCoder3D
{
    ...
    [
        ...
        new(TextureFormats.RgbaAstc3x3x3UNorm, PVRTexLibPixelFormat.ASTC_3x3x3, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc3x3x3Srgb, PVRTexLibPixelFormat.ASTC_3x3x3, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc3x3x3Float, PVRTexLibPixelFormat.ASTC_3x3x3, SourceKind.Rgba32Float, PVRTexLibVariableType.SignedFloat, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc4x3x3UNorm, PVRTexLibPixelFormat.ASTC_4x3x3, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc4x3x3Srgb, PVRTexLibPixelFormat.ASTC_4x3x3, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc4x3x3Float, PVRTexLibPixelFormat.ASTC_4x3x3, SourceKind.Rgba32Float, PVRTexLibVariableType.SignedFloat, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc4x4x3UNorm, PVRTexLibPixelFormat.ASTC_4x4x3, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc4x4x3Srgb, PVRTexLibPixelFormat.ASTC_4x4x3, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc4x4x3Float, PVRTexLibPixelFormat.ASTC_4x4x3, SourceKind.Rgba32Float, PVRTexLibVariableType.SignedFloat, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc4x4x4UNorm, PVRTexLibPixelFormat.ASTC_4x4x4, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc4x4x4Srgb, PVRTexLibPixelFormat.ASTC_4x4x4, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc4x4x4Float, PVRTexLibPixelFormat.ASTC_4x4x4, SourceKind.Rgba32Float, PVRTexLibVariableType.SignedFloat, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc5x4x4UNorm, PVRTexLibPixelFormat.ASTC_5x4x4, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc5x4x4Srgb, PVRTexLibPixelFormat.ASTC_5x4x4, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc5x4x4Float, PVRTexLibPixelFormat.ASTC_5x4x4, SourceKind.Rgba32Float, PVRTexLibVariableType.SignedFloat, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc5x5x4UNorm, PVRTexLibPixelFormat.ASTC_5x5x4, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc5x5x4Srgb, PVRTexLibPixelFormat.ASTC_5x5x4, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc5x5x4Float, PVRTexLibPixelFormat.ASTC_5x5x4, SourceKind.Rgba32Float, PVRTexLibVariableType.SignedFloat, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc5x5x5UNorm, PVRTexLibPixelFormat.ASTC_5x5x5, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc5x5x5Srgb, PVRTexLibPixelFormat.ASTC_5x5x5, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc5x5x5Float, PVRTexLibPixelFormat.ASTC_5x5x5, SourceKind.Rgba32Float, PVRTexLibVariableType.SignedFloat, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc6x5x5UNorm, PVRTexLibPixelFormat.ASTC_6x5x5, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc6x5x5Srgb, PVRTexLibPixelFormat.ASTC_6x5x5, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc6x5x5Float, PVRTexLibPixelFormat.ASTC_6x5x5, SourceKind.Rgba32Float, PVRTexLibVariableType.SignedFloat, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc6x6x5UNorm, PVRTexLibPixelFormat.ASTC_6x6x5, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc6x6x5Srgb, PVRTexLibPixelFormat.ASTC_6x6x5, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc6x6x5Float, PVRTexLibPixelFormat.ASTC_6x6x5, SourceKind.Rgba32Float, PVRTexLibVariableType.SignedFloat, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc6x6x6UNorm, PVRTexLibPixelFormat.ASTC_6x6x6, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc6x6x6Srgb, PVRTexLibPixelFormat.ASTC_6x6x6, SourceKind.Rgba8, PVRTexLibVariableType.UnsignedByteNorm, CompressorFamily.Astc),
        new(TextureFormats.RgbaAstc6x6x6Float, PVRTexLibPixelFormat.ASTC_6x6x6, SourceKind.Rgba32Float, PVRTexLibVariableType.SignedFloat, CompressorFamily.Astc)
    ];

    private static readonly TextureFormat[] SSupportedFormats = SMappings.Where(static mapping => mapping.Format.BlockDepth > 1).Select(static mapping => mapping.Format).ToArray();

    private readonly FormatMapping _mapping;
    private readonly PVRTexLibCompressorOptions _options;

    public PVRTexLib3DTextureCoder(TextureFormat format, PVRTexLibCompressorOptions? options = null)
    {
    ...
    public static bool IsSupported(TextureFormat format) => format.BlockDepth > 1 && TryGetMapping(format, out _);
        ...
        where TPixel : unmanaged, IPixel<TPixel>
    {
        ...
        {
            using var header = CreateCompressedHeader(destination.Width, destination.Height, destination.Depth);
            ...
            CopyTextureToVolumeBitmap(texture, destination);
        }
    }
        ...
        where TPixel : unmanaged, IPixel<TPixel>
    {
        ...
        EncodeCore(source, destination, rowPitch, slicePitch);
    }
    ...
    private void EncodeCore<TPixel>(VolumeBitmapView<TPixel> source, Span<byte> destination, int rowPitch, int slicePitch)
        where TPixel : unmanaged, IPixel<TPixel>
    {
        var pixelCount = checked(source.Width * source.Height * source.Depth);
        switch (_mapping.SourceKind)
        {
            case SourceKind.Rgba8:
                var rgba8 = new Rgba8UNorm[pixelCount];
                ...
                fixed (Rgba8UNorm* ptr = rgba8)
                {
                    TranscodeAndCopy(SRgba8PixelFormat, source.Width, source.Height, source.Depth, PVRTexLibVariableType.UnsignedByteNorm, ptr, destination, rowPitch, slicePitch);
                    return;
                }
            ...
            case SourceKind.Rgba8SNorm:
                ...
                fixed (Rgba8SNorm* ptr = rgba8SNorm)
                {
                    TranscodeAndCopy(SRgba8PixelFormat, source.Width, source.Height, source.Depth, PVRTexLibVariableType.SignedByteNorm, ptr, destination, rowPitch, slicePitch);
                    return;
                }
            ...
            case SourceKind.Rgba16UNorm:
                ...
                fixed (Rgba16UNorm* ptr = rgba16)
                {
                    TranscodeAndCopy(SRgba16PixelFormat, source.Width, source.Height, source.Depth, PVRTexLibVariableType.UnsignedShortNorm, ptr, destination, rowPitch, slicePitch);
                    return;
                }
            ...
            case SourceKind.Rgba16SNorm:
                ...
                fixed (Rgba16SNorm* ptr = rgba16SNorm)
                {
                    TranscodeAndCopy(SRgba16PixelFormat, source.Width, source.Height, source.Depth, PVRTexLibVariableType.SignedShortNorm, ptr, destination, rowPitch, slicePitch);
                    return;
                }
            ...
            case SourceKind.Rgba32Float:
                ...
                fixed (Rgba32Float* ptr = rgba32Float)
                {
                    TranscodeAndCopy(SRgba32PixelFormat, source.Width, source.Height, source.Depth, _mapping.ChannelType, ptr, destination, rowPitch, slicePitch);
                    return;
                }
    ...
    private void CopyTextureToVolumeBitmap<TPixel>(PVRTexture texture, VolumeBitmapView<TPixel> destination)
        where TPixel : unmanaged, IPixel<TPixel>
    {
        for (var z = 0; z < destination.Depth; z++)
        {
            var data = texture.GetTextureDataConstPointer(0, arrayMember: 0, faceNumber: 0, ZSlice: checked((uint)z));
            if (data is null)
            {
                throw new InvalidOperationException("PVRTexLib returned an empty texture payload.");
            }

            CopyTextureSliceToBitmap(data, destination.GetSliceView(z));
        }
    }

    private void CopyTextureSliceToBitmap<TPixel>(void* data, BitmapView<TPixel> destination)
        where TPixel : unmanaged, IPixel<TPixel>
    {
        var pixelCount = checked(destination.Width * destination.Height);
        switch (_mapping.SourceKind)
    ...
    private PVRTextureHeader CreateCompressedHeader(int width, int height) =>
        CreateCompressedHeader(width, height, depth: 1);

    private PVRTextureHeader CreateCompressedHeader(int width, int height, int depth) =>
        new(
        ...
        int slicePitch)
    {
        ...
        var packedSize = GetPackedByteCount(width, height, depth);
        var textureData = texture.GetTextureDataConstPointer(0, arrayMember: 0, faceNumber: 0, ZSlice: 0);
        if (textureData is null || texture.GetTextureDataSize(0, allSurfaces: false, allFaces: false) < (ulong)packedSize)
        {
            throw new InvalidOperationException("PVRTexLib returned an empty or incomplete texture payload.");
        ...
        CopyPackedBlocksToDestination(new ReadOnlySpan<byte>(textureData, packedSize), width, height, depth, destination, rowPitch, slicePitch);
    }
    ...
    {
        if (Format.BlockDepth != 1)
        {
            throw new NotSupportedException($"Use the 3D texture coder APIs for texture format '{Format.Name}'.");
        }
    }
