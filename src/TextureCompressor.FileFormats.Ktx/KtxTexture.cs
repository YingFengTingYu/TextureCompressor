...
public sealed class KtxTexture
{
    ...
    public KtxTexture(
        ...
        : this(format, [new TextureSubresource(0, 0, 0, width, height, payload)], 1, 1, glType, glFormat, glInternalFormat, glBaseInternalFormat, vkFormat)
    {
    }
    ...
    public KtxTexture(
        ...
        KtxGlFormat? glBaseInternalFormat,
        KtxVkFormat? vkFormat)
        : this(format, ToSubresources(mipLevels, "KTX"), 1, 1, glType, glFormat, glInternalFormat, glBaseInternalFormat, vkFormat)
    {
    }
    ...
    public KtxTexture(TextureFormat format, IReadOnlyList<TextureSubresource> subresources, int arrayLayerCount, int faceCount)
        : this(format, subresources, arrayLayerCount, faceCount, glType: null, glFormat: null, glInternalFormat: null, glBaseInternalFormat: null, vkFormat: null)
    {
    }
    ...
    public KtxTexture(
        ...
        KtxVkFormat? vkFormat)
    {
        var resources = ValidateSubresources(subresources, arrayLayerCount, faceCount, "KTX");
